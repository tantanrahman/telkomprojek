...
<body>
        <div class="container-fluid">
            ...
            <h2 align="center">
            Lembar Pendapatan Indovision Finnet
            </h2>
            <h2 align="center">
                <?php 
        ...
        <form method="post" action="pen_voucher_edit.php">
            <div>
                ...
                <?php
                    ...
                    if ($tanggal1==$tanggal2)
                        {
                    $query=mysql_query("select lokasi.lokasi,lokasi.loket as looket, IFNULL(sum(indovision.tagihan),0) as tagihan,IFNULL(sum(indovision.fee_ca),0) as fee_ca,IFNULL(sum(indovision.fee_finnet),0) as fee_finnet,IFNULL(sum(indovision.kewajiban),0) as kewajiban from lokasi left join indovision on  lokasi.loket=indovision.loket AND tanggal='$tampil_date' group by lokasi.loket");
                        }
                        else
                        {
