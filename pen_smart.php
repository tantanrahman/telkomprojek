        ...
        <form method="post" action="pen_voucher_edit.php">
            <div>
                ...
                <?php
                    ...
                    if ($tanggal1==$tanggal2)
                        {
                    $query=mysql_query("select lokasi.lokasi,lokasi.loket as looket, voucher_smart.tanggal, voucher_smart.loket,  voucher_smart.denom as denom, 
                        sum(voucher_smart.total_kopeg) as total_kopeg1, voucher_smart.total_kopeg as total_kopeg2, count(voucher_smart.denom) as hitung  ,  voucher_smart.user, fee_ca*count(voucher_smart.denom) as fee_ca from lokasi left join voucher_smart on voucher_smart.user=lokasi.loket where tanggal='$tampil_date' or tanggal is NULL group by lokasi, denom");
                        }
                        else
                        {
