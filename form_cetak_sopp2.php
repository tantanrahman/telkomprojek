<center>
    ...
    <br>
    <br>
<form action="proses_cetak_pen_sopp3.php" method="post" target="_blank">
                <table>
                    <tr>
                        <td>
                ...
                <br>
                <button type="submit" class="btn btn-primary" name="filter"><i class="fa fa-print fa-fw"></i> Cetak Pendapatan SOPP</button>
</form>