...
<body>
            ...
            <br></br>
                ...
                <button id="cetak" class="btn pull-right">Cetak</button>
                    <a href="pdf/pdf_pen_pdam.php?kolom=<?php echo $kolom ?>&nilai=<?php echo $nilai ?>&nilai2=<?php echo $nilai2 ?>" button type="submit" class="btn btn-default">Export To PDF</button></a>
