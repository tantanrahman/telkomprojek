<center>
    ...
    <br>
    <br>
<form action="proses_cetak_pen_voucher.php" method="post" target="_blank">
                <table>
                    <tr>
                        <td>
                ...
                <br>
                <button type="submit" class="btn btn-primary" name="filter">Cetak Pendapatan Voucher</button>
</form>
</center>
